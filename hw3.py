...
class Cell:
    ...
    def __sub__(self, other):
        if other.__class__.__name__ != "Cell" or self.cnt < other.cnt:
            return None
        if self.cnt > 0 and other.cnt > 0:
            return Cell(self.cnt - other.cnt)
        else:
            print("количество ячеек двух клеток должно быть больше нуля")
            return None
    ...
    def __truediv__(self, other):
        if other.__class__.__name__ != "Cell" or self.cnt < other.cnt:
            return None
        return Cell(int(self.cnt / other.cnt))


cell_1 = Cell(10)
cell_2 = Cell(21)
Cell.make_order(cell_2, 4)
